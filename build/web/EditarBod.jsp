    ...
    <body>
        ...
        <div>
            <form name="form" action="Controlador" method="POST">
                ...
                Nombre Bodega: <br>
                <input type="text" onclick="borrar_nombre();" name="txtNombre" value="${bodega.getNOMBRE()}">
                <label id="error" style="color:red"></label><br>
                Tienda: <br>
                <input type="text" onclick="borrar_tienda();" name="txtTienda" value="${bodega.getTIENDA()}"> 
                <label id="error1" style="color:red"></label><br>
                Direccion: <br>
                <input type="text" onclick="borrar_direccion();" name="txtDireccion" value="${bodega.getDIRECCION()}">
                <label id="error2" style="color:red"></label><br>
                <input onclick="return validar();" class="btn btn-success" onclick="return validar();" type="submit" name="accion" value="Actualizar Bodega" <br>
            </form>
        </div>
                <script type="text/javascript">
                function validar(){
                  if(!validar_nombre() || !validar_tienda() || !validar_direccion()){ 
